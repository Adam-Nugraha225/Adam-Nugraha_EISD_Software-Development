...
func main() {
	...
	fmt.Println("Masukkan nama anda(jangan dispasi): ")
	fmt.Scan(&nama)

	fmt.Println("gunakan huruf kecil semua dan jangan gunakan spasi")
	fmt.Println("Masukkan nama pesanan makanan: ")
	fmt.Scan(&makanan)
	fmt.Println("Masukkan jumlah pesanan makanan: ")
	fmt.Scan(&jumlahPesananMakanan)

	fmt.Println("Masukkan nama pesanan minuman: ")
	fmt.Scan(&minuman)
	fmt.Println("Masukkan jumlah pesanan minuman: ")
